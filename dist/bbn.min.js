...
return{version:"1.0.1",opt:{_cat:{}},_(st,namespace){if(namespace&&bbn.fn.isString(namespace)){if(namespace.indexOf('_')!==0){namespace='_'+namespace;}
...
return st;},percent(percent,cent){return(cent/100)*percent;},dirName(path){if(bbn.fn.isString(path)&&path){while(path.substr(path.length-1)==='/'){path=path.substr(0,path.length-1);}
let pos=path.lastIndexOf('/');if(pos>0){return path.substr(0,pos);}
if(pos===0){return'/';}}
