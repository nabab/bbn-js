...
return st;},percent(percent,cent){return(cent/100)*percent;},substr(str,from,length){if(!bbn.fn.isString(str)||!bbn.fn.isInt(from)){throw new Error(_("The substr function should be applied to a string and at least a from argument should be given"));}
