...
return true;},isURL(str){return bbn.var.regexp.url.test(str);},isIP(st){if(bbn.fn.isString(st)){return bbn.var.regexp.ip.test(st);}},isHostname(){if(bbn.fn.isString(st)){if(bbn.fn.isIp(st)){return true;}
